// Domain types for Person and tree structure

export interface PersonTranslationFields {
    name?: string;
    relation?: string;
    occupation?: string;
    bio?: string;
...
export interface PersonTranslations {
    EN?: PersonTranslationFields;
    HI?: PersonTranslationFields;
    GU?: PersonTranslationFields;
}
